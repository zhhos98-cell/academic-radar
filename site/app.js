const translations = {
  ...
  zh: {
    ...
    "group.profile.heading": "配置档案",
    "group.profile.body": "命名本地配置，并选择用于避免重复条目的状态文件。",
    "group.vocabulary.heading": "领域词表",
    "group.vocabulary.body": "定义哪些内容属于你的研究领域，哪些内容应被降低权重或排除。",
    "group.bsky.heading": "Bluesky",
    "group.bsky.body": "把公共检索式和少量相关账号关注列表结合起来。",
    "group.rss.heading": "RSS 与限制",
